...
func TestSessionStore_GetMissingReturnsErrNoSession(t *testing.T) {
	s, cleanup := newTestSessionStore(t)
	defer cleanup()
...
func TestSessionStore_GetExpiredReturnsErrNoSession(t *testing.T) {
	s, cleanup := newTestSessionStore(t)
	defer cleanup()
...
func TestSessionStore_IDLengthAndAlphabet(t *testing.T) {
	s, cleanup := newTestSessionStore(t)
	defer cleanup()
