...
func behavioralRules() string {
	return strings.Join([]string{
		...
		"If a tool returns an error (e.g., the search backend is unreachable), TELL the user exactly what the error says — do not try to answer the question yourself and never invent search results to fill the gap.",
